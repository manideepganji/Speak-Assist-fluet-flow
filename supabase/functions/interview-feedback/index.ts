...
serve(async (req) => {
  ...
  try {
    const { question, answer, category, apiKey } = await req.json();
      ...
      body: JSON.stringify({
        ...
        tools: [
          {
            function_declarations: [
              {
                name: "provide_interview_feedback",
                description: interviewFeedbackTool.function.description,
                parameters: interviewFeedbackTool.function.parameters
              }
            ]
          }
        ],
        tool_config: {
          function_calling_config: {
            mode: "ANY",
            allowed_function_names: ["provide_interview_feedback"]
          }
        },
        generationConfig: {
