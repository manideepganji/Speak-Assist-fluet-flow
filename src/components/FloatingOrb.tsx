            ...
            {showSuggestion && currentResponse && (
              ...
              >
                <div className="glass rounded-2xl p-4 orb-glow space-y-3">
                  ...
                  {currentResponse.pronunciation_feedback && currentResponse.pronunciation_feedback.has_issues && (
                    <div className="space-y-2 pt-2 border-t border-orb-glow/20">
                      <h4 className="text-xs font-medium text-orb-glow">Pronunciation Tips</h4>
                      {currentResponse.pronunciation_feedback.corrections.map((correction, index) => (
                        <div key={index} className="text-xs text-orb-text-muted">
                          <span className="font-medium text-orb-text">{correction.word}</span>
                          <span className="mx-1">→</span>
                          <span className="text-orb-glow italic">{correction.phonetic_guide}</span>
                          <div className="text-orb-text-muted mt-0.5">{correction.tip}</div>
                        </div>
                      ))}
                      {currentResponse.pronunciation_feedback.encouragement && (
                  ...
                  {currentResponse.pronunciation_feedback && !currentResponse.pronunciation_feedback.has_issues && (
                    <div className="pt-2 border-t border-orb-glow/20">
